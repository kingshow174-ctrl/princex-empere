...
app.get("/config.js", (req, res) => {
  ...
  const pairs = [
    "EUR/USD","CAD/JPY","GBP/AUD","EUR/GBP","EUR/CAD","GBP/CAD","GBP/JPY","AUD/USD",
    "CHF/JPY","AUD/CHF","GBP/CHF","AUD/CAD","GBP/USD","USD/JPY","USD/CHF","USD/CAD",
    "EUR/JPY","EUR/AUD","EUR/NZD","EUR/CHF","AUD/JPY","AUD/NZD","CAD/CHF","NZD/USD",
    "NZD/JPY","NZD/CAD","NZD/CHF","XAU/USD","BTC/USD","ETH/USD"
  ];
...
// Serve Gemini key safely
app.get("/gemini-config.js", (req, res) => {
  res.setHeader("Content-Type", "application/javascript");
  res.send(`window.GEMINI_API_KEY = "${process.env.GEMINI_KEY || 'AQ.Ab8RN6JUBVo95w4cTe0kHA8k7oflkVw3Q4icZOymGaBAI-IJfg'}";`);
});
